...
const listaQuimicosParaFerreterias = [
    ...
    { price: 3388.00, codigo: '1000', name: 'ALCOHOL FINO X 1 lt.', imagen: imageURL, descripcion: 'Descripción del producto', category: subRubroQuimDilu03 },
    { price: 2589.97, codigo: '1001', name: 'ALCOHOL DE QUEMAR x 1 lt.', imagen: imageURL, descripcion: 'Descripción del producto', category: subRubroQuimDilu03 },
    ...
    { price: 13311.00, codigo: '1046', name: 'SELLADOR PARA CAÑOS DE GAS X 50 grs.', imagen: imageURL, descripcion: 'Descripción del producto', category: subRubroQuimDilu03 },
    { price: 1870.00, codigo: '1048', name: 'ADHESIVO DE CONTACTO X 125 cc.', imagen: imageURL, descripcion: 'Descripción del producto', category: subRubroQuimDilu03 },
    { price: 2420.80, codigo: '1050', name: 'ADHESIVO PVC X 100 C. C.', imagen: imageURL, descripcion: 'Descripción del producto', category: subRubroQuimDilu03 },
    { price: 1172.80, codigo: '1056', name: 'LITARGIRIO X 100 grs.', imagen: imageURL, descripcion: 'Descripción del producto', category: subRubroQuimDilu03 },
    { price: 544.00, codigo: '1060', name: 'GLICERINA PURA X 100 grs', imagen: imageURL, descripcion: 'Descripción del producto', category: subRubroQuimDilu03 },
    { price: 646.40, codigo: '1066', name: 'CAÑAMO PEINODO FINO X 20 grs.', imagen: imageURL, descripcion: 'Descripción del producto', category: subRubroQuimDilu03 },
    { price: 953.60, codigo: '1068', name: 'GRASA DE LITIO X 125 grs.', imagen: imageURL, descripcion: 'Descripción del producto', category: subRubroQuimDilu03 },
    { price: 560.00, codigo: '1070', name: 'GRASA GRAFITADA X 40 grs.', imagen: imageURL, descripcion: 'Descripción del producto', category: subRubroQuimDilu03 },
    { price: 680.00, codigo: '1075', name: 'DECAPANTE X 70 GS.', imagen: imageURL, descripcion: 'Descripción del producto', category: subRubroQuimDilu03 },
    { price: 7400.61, codigo: '1076', name: 'FUNDENTE DE PLATA X 100 grs.', imagen: imageURL, descripcion: 'Descripción del producto', category: subRubroQuimDilu03 },
    { price: 533.34, codigo: '1080', name: 'MASILLA PARA VIDRIOS Y SANITARIOS X 500 grs.', imagen: imageURL, descripcion: 'Descripción del producto', category: subRubroQuimDilu03 },
    { price: 800.08, codigo: '1081', name: 'MASILLA PARA VIDRIOS Y SANITARIOS X 1 kg', imagen: imageURL, descripcion: 'Descripción del producto', category: subRubroQuimDilu03}
];
