...
const listaSika = [
    {
        codigo: 2800,
        name: "SIKA HIDROFUGO x 1kg. (Sachet)",
        price: 1683.00,
        imagen: images.artConstru.image2800,
    ...
    {
        codigo: 2801,
        name: "SIKA HIDROFUGO x 5kg. (Caja)",
        price: 5049.00,
        imagen: images.artConstru.image2801,
        descripcion: "El Sikatop Seal-107 es un sellador líquido de alta tecnología, elástico, de un solo componente, basado en polímeros modificados con silano-siloxano. Está formulado para penetrar, sellar y proteger una variedad de superficies minerales porosas.",
        category: subRubroArtContr04
    },
    {
        codigo: 2802,
        name: "SIKA ANTICONGE S/CLORURO FRIOLITE X 5lts.",
        price: 49743.36,
        imagen: images.artConstru.image2802,
    ...
    {
        codigo: 2803,
        name: "SIKA ANTICONGE. DE HORMIGON  ANTIFROSTO x 6lts.",
        price: 22950.00,
        imagen: images.artConstru.image2803,
    ...
    {
        codigo: 2804,
        name: "SIKA LIGANTE DE HORMIGON x 1lt.",
        price: 6462.72,
        imagen: images.artConstru.image2804,
    ...
    {
        codigo: 2805,
        name: "SIKA LIGANTE DE HORMIGON x 4lts.",
        price: 23482.44,
        imagen: images.artConstru.image2805,
        descripcion: "El Sika Ligante de Hormigón es un aditivo líquido, monocomponente, a base de ácidos orgánicos que inhiben la corrosión en armaduras de acero.",
        category: subRubroArtContr04
    },
    {
        codigo: 2812,
        name: "MACRONITA 0.60M X 50M X 1kg.",
        price: 12216.60,
        imagen: images.artConstru.image2812,
